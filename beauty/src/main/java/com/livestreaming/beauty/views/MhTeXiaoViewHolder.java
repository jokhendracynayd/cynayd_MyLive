...
import com.livestreaming.beauty.adapter.MeiYanTitleAdapter;
import com.livestreaming.beauty.adapter.ViewPagerAdapter;
import com.livestreaming.beauty.bean.MeiYanTypeBean;
...
public class MhTeXiaoViewHolder extends AbsMhChildViewHolder implements View.OnClickListener {
    ...
    private void showTieZhiDownloadTip(int state){
        if (state == 0){
            mTip.setText(WordUtil.getString(R.string.beauty_mh_texiao_action_downloading));
