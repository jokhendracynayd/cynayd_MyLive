...
import com.livestreaming.beauty.adapter.TieZhiTitleAdapter;
import com.livestreaming.beauty.adapter.ViewPagerAdapter;
import com.livestreaming.beauty.bean.TieZhiBean;
import com.livestreaming.beauty.bean.TieZhiTypeBean;
...
public class MhTieZhiViewHolder extends AbsMhChildViewHolder implements View.OnClickListener, MhTieZhiChildViewHolder.ActionListener {
    ...
    public void init() {
        ...
        typeList.add(new TieZhiTypeBean(MHSDK.TIEZHI_BASIC_STICKER, WordUtil.getString(R.string.beauty_mh_005), false, MHConfigConstants.TIE_ZHI_1));
        typeList.add(new TieZhiTypeBean(MHSDK.TIEZHI_PRO_STICKER, WordUtil.getString(R.string.beauty_mh_006), true, MHConfigConstants.TIE_ZHI_2));
        typeList.add(new TieZhiTypeBean(MHSDK.TIEZHI_BASIC_MASK, WordUtil.getString(R.string.beauty_mh_007), false,MHConfigConstants.TIE_ZHI_3));
        typeList.add(new TieZhiTypeBean(MHSDK.TIEZHI_PRO_MASK, WordUtil.getString(R.string.beauty_mh_008), true,MHConfigConstants.TIE_ZHI_4));
