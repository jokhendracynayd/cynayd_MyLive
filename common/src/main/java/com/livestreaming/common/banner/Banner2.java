package com.livestreaming.common.banner;
...
import com.livestreaming.common.banner.indicator.Indicator;
import com.livestreaming.common.banner.listener.OnPageChangeListener;
import com.livestreaming.common.banner.transformer.MZScaleInTransformer;
import com.livestreaming.common.banner.transformer.ScaleInTransformer;
import com.livestreaming.common.banner.util.BannerLifecycleObserver;
import com.livestreaming.common.banner.util.BannerLifecycleObserverAdapter;
import com.livestreaming.common.banner.util.BannerUtils;
import com.livestreaming.common.banner.util.ScrollSpeedManger;
...
public class Banner2<T, BA extends BannerAdapter<T>> extends FrameLayout implements BannerLifecycleObserver {
    ...
    public Banner2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initTypedArray(Context context, AttributeSet attrs) {
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.Banner2);
            mBannerRadius = a.getDimensionPixelSize(R.styleable.Banner2_banner_radius, 0);
            mLoopTime = a.getInt(R.styleable.Banner2_banner_loop_time, BannerConfig.LOOP_TIME);
            mIsAutoLoop = a.getBoolean(R.styleable.Banner2_banner_auto_loop, BannerConfig.IS_AUTO_LOOP);
            mIsInfiniteLoop = a.getBoolean(R.styleable.Banner2_banner_infinite_loop, BannerConfig.IS_INFINITE_LOOP);
            normalWidth = a.getDimensionPixelSize(R.styleable.Banner2_banner_indicator_normal_width, BannerConfig.INDICATOR_NORMAL_WIDTH);
            selectedWidth = a.getDimensionPixelSize(R.styleable.Banner2_banner_indicator_selected_width, BannerConfig.INDICATOR_SELECTED_WIDTH);
            normalColor = a.getColor(R.styleable.Banner2_banner_indicator_normal_color, BannerConfig.INDICATOR_NORMAL_COLOR);
            selectedColor = a.getColor(R.styleable.Banner2_banner_indicator_selected_color, BannerConfig.INDICATOR_SELECTED_COLOR);
            indicatorGravity = a.getInt(R.styleable.Banner2_banner_indicator_gravity, IndicatorConfig.Direction.CENTER);
            indicatorSpace = a.getDimensionPixelSize(R.styleable.Banner2_banner_indicator_space, 0);
            indicatorMargin = a.getDimensionPixelSize(R.styleable.Banner2_banner_indicator_margin, 0);
            indicatorMarginLeft = a.getDimensionPixelSize(R.styleable.Banner2_banner_indicator_marginLeft, 0);
            indicatorMarginTop = a.getDimensionPixelSize(R.styleable.Banner2_banner_indicator_marginTop, 0);
            indicatorMarginRight = a.getDimensionPixelSize(R.styleable.Banner2_banner_indicator_marginRight, 0);
            indicatorMarginBottom = a.getDimensionPixelSize(R.styleable.Banner2_banner_indicator_marginBottom, 0);
            indicatorHeight = a.getDimensionPixelSize(R.styleable.Banner2_banner_indicator_height, BannerConfig.INDICATOR_HEIGHT);
            indicatorRadius = a.getDimensionPixelSize(R.styleable.Banner2_banner_indicator_radius, BannerConfig.INDICATOR_RADIUS);
            mOrientation = a.getInt(R.styleable.Banner2_banner_orientation, HORIZONTAL);
            mRoundTopLeft = a.getBoolean(R.styleable.Banner2_banner_round_top_left, false);
            mRoundTopRight = a.getBoolean(R.styleable.Banner2_banner_round_top_right, false);
            mRoundBottomLeft = a.getBoolean(R.styleable.Banner2_banner_round_bottom_left, false);
            mRoundBottomRight = a.getBoolean(R.styleable.Banner2_banner_round_bottom_right, false);
            a.recycle();
        }
    ...
    static class AutoLoopTask implements Runnable {
        private final WeakReference<Banner2> reference;

        AutoLoopTask(Banner2 banner) {
            this.reference = new WeakReference<>(banner);
        }

        @Override
        public void run() {
            Banner2 banner = reference.get();
     ...
     * @return
     */
    public Banner2 setIntercept(boolean intercept) {
     ...
     * @return
     */
    public Banner2 setCurrentItem(int position) {
     ...
     * @return
     */
    public Banner2 setCurrentItem(int position, boolean smoothScroll) {
        getViewPager2().setCurrentItem(position, smoothScroll);
        return this;
    }

    public Banner2 setIndicatorPageChange() {
        if (getIndicator() != null) {
    ...
    public Banner2 removeIndicator() {
        if (getIndicator() != null) {
     ...
     */
    public Banner2 setStartPosition(int mStartPosition) {
     ...
     */
    public Banner2 setUserInputEnabled(boolean enabled) {
     ...
     */
    public Banner2 addPageTransformer(@Nullable ViewPager2.PageTransformer transformer) {
     ...
     */
    public Banner2 setPageTransformer(@Nullable ViewPager2.PageTransformer transformer) {
        getViewPager2().setPageTransformer(transformer);
        return this;
    }

    public Banner2 removeTransformer(ViewPager2.PageTransformer transformer) {
     ...
     * 添加 ItemDecoration
     */
    public Banner2 addItemDecoration(RecyclerView.ItemDecoration decor) {
        getViewPager2().addItemDecoration(decor);
        return this;
    }

    public Banner2 addItemDecoration(RecyclerView.ItemDecoration decor, int index) {
     ...
     */
    public Banner2 isAutoLoop(boolean isAutoLoop) {
     ...
     */
    public Banner2 setLoopTime(long loopTime) {
     ...
     * 设置轮播滑动过程的时间
     */
    public Banner2 setScrollTime(int scrollTime) {
     ...
     * 设置banner的适配器
     */
    public Banner2 setAdapter(BA adapter) {
        if (adapter == null) {
     ...
     * @return
     */
    public Banner2 setAdapter(BA adapter, boolean isInfiniteLoop) {
     ...
     */
    public Banner2 setDatas(List<T> datas) {
        if (getAdapter() != null) {
            getAdapter().refreshData(datas);
            setCurrentItem(mStartPosition, false);
            setIndicatorPageChange();
            start();
        }
     ...
     */
    public Banner2 setOrientation(@Orientation int orientation) {
     ...
     * 改变最小滑动距离
     */
    public Banner2 setTouchSlop(int mTouchSlop) {
     ...
     * </p>
     */
    public Banner2 addOnPageChangeListener(OnPageChangeListener pageListener) {
     ...
     * @param radius 圆角半径
     */
    public Banner2 setBannerRound(float radius) {
    ...
    public Banner2 setBannerRound2(float radius) {
     ...
     */
    public Banner2 setBannerGalleryEffect(int itemWidth, int pageMargin) {
     ...
     * @param pageMargin     页面间距,单位dp
     */
    public Banner2 setBannerGalleryEffect(int leftItemWidth, int rightItemWidth, int pageMargin) {
     ...
     */
    public Banner2 setBannerGalleryEffect(int itemWidth, int pageMargin, float scale) {
     ...
     * @param scale          缩放[0-1],1代表不缩放
     */
    public Banner2 setBannerGalleryEffect(int leftItemWidth, int rightItemWidth, int pageMargin, float scale) {
        if (pageMargin > 0) {
     ...
     * @param itemWidth item左右展示的宽度,单位dp
     */
    public Banner2 setBannerGalleryMZ(int itemWidth) {
     ...
     * @param scale     缩放[0-1],1代表不缩放
     */
    public Banner2 setBannerGalleryMZ(int itemWidth, float scale) {
        if (scale < 1 && scale > 0) {
     ...
     * 设置轮播指示器(显示在banner上)
     */
    public Banner2 setIndicator(Indicator indicator) {
     ...
     */
    public Banner2 setIndicator(Indicator indicator, boolean attachToBanner) {
        removeIndicator();
    ...
    public Banner2 setIndicatorSelectedColor(@ColorInt int color) {
    ...
    public Banner2 setIndicatorSelectedColorRes(@ColorRes int color) {
        setIndicatorSelectedColor(ContextCompat.getColor(getContext(), color));
        return this;
    }

    public Banner2 setIndicatorNormalColor(@ColorInt int color) {
        if (getIndicatorConfig() != null) {
    ...
    public Banner2 setIndicatorNormalColorRes(@ColorRes int color) {
        setIndicatorNormalColor(ContextCompat.getColor(getContext(), color));
        return this;
    }

    public Banner2 setIndicatorGravity(@IndicatorConfig.Direction int gravity) {
    ...
    public Banner2 setIndicatorSpace(int indicatorSpace) {
        if (getIndicatorConfig() != null) {
    ...
    public Banner2 setIndicatorMargins(IndicatorConfig.Margins margins) {
        if (getIndicatorConfig() != null && getIndicatorConfig().isAttachToBanner()) {
    ...
    public Banner2 setIndicatorWidth(int normalWidth, int selectedWidth) {
        if (getIndicatorConfig() != null) {
    ...
    public Banner2 setIndicatorNormalWidth(int normalWidth) {
        if (getIndicatorConfig() != null) {
            getIndicatorConfig().setNormalWidth(normalWidth);
        }
        return this;
    ...
    public Banner2 setIndicatorSelectedWidth(int selectedWidth) {
        if (getIndicatorConfig() != null) {
            getIndicatorConfig().setSelectedWidth(selectedWidth);
        }
        return this;
    ...
    public Banner2 setIndicatorRadius(int indicatorRadius) {
        if (getIndicatorConfig() != null) {
    ...
    public Banner2 setIndicatorHeight(int indicatorHeight) {
        if (getIndicatorConfig() != null) {
    ...
    public Banner2 addBannerLifecycleObserver(LifecycleOwner owner) {
        if (owner != null) {
