package com.livestreaming.common.banner.util;
...
public class ScrollSpeedManger extends LinearLayoutManager {
    ...
    public ScrollSpeedManger(Banner2 banner, LinearLayoutManager linearLayoutManager) {
    ...
    public static void reflectLayoutManager(Banner2 banner) {
