...
public class UserBean implements Parcelable {
    ...
    public int getIsDataEditedFirst() {
        return is_data_edited_first;
    }

    public void setIsDataEditedFirst(int is_data_edited_first) {
        this.is_data_edited_first = is_data_edited_first;
    }

    protected int is_data_edited_first;
    private int mIsOpenShop; //是否开通商城 1开通 0未开通
    private int mIsOpenPayContent; //是否开通付费内容 1开通 0未开通
    ...
    @JSONField(name = "shop_switch")
    public void setIsOpenShop(int isOpenShop) {
        mIsOpenShop = isOpenShop;
    }

    @JSONField(name = "paidprogram_switch")
    public int getIsOpenPayContent() {
        return mIsOpenPayContent;
    }

    @JSONField(name = "paidprogram_switch")
    public void setIsOpenPayContent(int isOpenPayContent) {
        mIsOpenPayContent = isOpenPayContent;
    }
