...
public class TabButton extends LinearLayout {
    ...
    private final float mScaleMax = 1.7f;
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                if (mDrawableIndex != index) {
                    ...
                    if (mImg != null) {
                        ...
                        float scale = v / (mDrawaleArrayLength - 1) * mScaleMax;
    ...
    protected void onFinishInflate() {
        ...
        params1.setMargins(0, dp2px(14), 0, 0);
        mImg.setLayoutParams(params1);
        mImg.setPivotX(mIconSize / 2f);
        mImg.setPivotY(mIconSize - dp2px(5));
        if (mDrawables != null && mDrawaleArrayLength > 0) {
            if (mChecked) {
                mImg.setScaleX(mScaleMax);
                mImg.setScaleY(mScaleMax);
