...
//						ImageScroller scroller = new ImageScroller(start, end, 300, getDrawable(), this, bitmapChangeListener);
	...
	public final static float DEFAULT_MID_SCALE = 1.75f;//中间比例
	public final static float DEFAULT_NORMAL_SCALE = 1f;//正常显示的比例，也是回弹时的比例，也是显示的最小比例
	public final static float DEFAULT_MIN_SCALE = 1f;//最小缩放比例，手势操作时的最小缩小比例
