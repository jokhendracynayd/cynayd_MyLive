...
import com.livestreaming.game.custom.ZpBetView;
...
public class GameZpViewHolder extends AbsGameViewHolder {
    ...
    public void anchorCreateGame() {
        ...
        GameHttpUtil.gameLuckPanCreate(mStream, new HttpCallback() {
            @Override
            public void onSuccess(int code, String msg, String[] info) {
                if (code == 0) {
                    ...
                    if (mGameActionListener != null) {
                        mGameActionListener.zpAnchorNotifyGameBet(mLiveUid, mGameID, mGameToken, mBetTime);
                    }
                } else {
                    ToastUtil.show(msg);
                }
    ...
    private void audienceBetGame(final int index) {
        GameHttpUtil.gameLuckPanBet(mGameID, mBetMoney, index, new HttpCallback() {
            @Override
            public void onSuccess(int code, String msg, String[] info) {
                if (code == 0 && info.length > 0) {
                    JSONObject obj = JSON.parseObject(info[0]);
                    ...
                    if (mGameActionListener != null) {
                        mGameActionListener.zpAudienceBetGame(mBetMoney, index);
                    }
                } else {
                    ToastUtil.show(msg);
                }
    ...
    public void anchorCloseGame() {
        ...
        if (mGameActionListener != null) {
            mGameActionListener.zpAnchorCloseGame();
        }
    ...
    public void onClick(View v) {
        ...
        } else if (i == R.id.role_2) {
            audienceBetGame(2);

        } else if (i == R.id.role_3) {
            audienceBetGame(3);

        } else if (i == R.id.role_4) {
            audienceBetGame(4);
