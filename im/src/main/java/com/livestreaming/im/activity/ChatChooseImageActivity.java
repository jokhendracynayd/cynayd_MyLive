...
import com.livestreaming.common.utils.ChooseImageUtil;
import com.livestreaming.common.utils.ToastUtil;
import com.livestreaming.common.utils.WordUtil;
import com.livestreaming.im.R;
import com.livestreaming.im.adapter.ImChatChooseImageAdapter;
    ...
    private void sendImage() {
        if (mAdapter != null) {
            ...
            if (file != null && file.exists()) {
                ...
                ToastUtil.show(WordUtil.getString(com.livestreaming.common.R.string.im_please_choose_image));
            }
        } else {
            ToastUtil.show(WordUtil.getString(com.livestreaming.common.R.string.im_no_image));
        }
    }
