...
public class ImChatChooseImageAdapter extends RefreshAdapter<ChooseImageBean> {
    ...
    public ImChatChooseImageAdapter(Context context, List<ChooseImageBean> list) {
        super(context, list);
        mCheckedDrawable = ContextCompat.getDrawable(context, com.livestreaming.common.R.mipmap.icon_checked);
        mUnCheckedDrawable = ContextCompat.getDrawable(context, com.livestreaming.common.R.mipmap.icon_checked_none);
    ...
    class Vh extends RecyclerView.ViewHolder {
        ...
        void setData(ChooseImageBean bean, int position, Object payload) {
            if (payload == null) {
                ...
                ImgLoader.display(mContext, bean.getImageUri(), mCover);
            }
