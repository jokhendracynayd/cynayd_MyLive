...
import com.livestreaming.live.views.LiveMyLiveRoomViewHolder;
import com.livestreaming.live.views.LiveMyRoomViewHolder;
...
public class RoomManageActivity extends AbsActivity {
    ...
    protected void main() {
        ...
        final String[] titles = new String[]{WordUtil.getString(com.livestreaming.common.R.string.live_my_live_room), WordUtil.getString(com.livestreaming.common.R.string.live_my_room)};
