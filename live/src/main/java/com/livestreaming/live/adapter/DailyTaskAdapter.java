...
public class DailyTaskAdapter extends RefreshAdapter<DailyTaskBean> {
    ...
    public DailyTaskAdapter(Context context, List<DailyTaskBean> list) {
        ...
        mStatus0 = WordUtil.getString(com.livestreaming.common.R.string.daily_task_0);
        mStatus1 = WordUtil.getString(com.livestreaming.common.R.string.daily_task_1);
        mStatus2 = WordUtil.getString(com.livestreaming.common.R.string.daily_task_2);
        mColor0 = ContextCompat.getColor(mContext, com.livestreaming.common.R.color.gray3);
        mColor1 = ContextCompat.getColor(mContext,com.livestreaming.common. R.color.white);
