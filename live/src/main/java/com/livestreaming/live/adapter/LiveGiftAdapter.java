...
public class LiveGiftAdapter extends RecyclerView.Adapter<LiveGiftAdapter.Vh> {
    ...
    public LiveGiftAdapter(Context context, LayoutInflater inflater, List<LiveGiftBean> list, String coinName, int giftType) {
        ...
        mGe = WordUtil.getString(com.livestreaming.common.R.string.ge);
        mDrawableHot = ContextCompat.getDrawable(mContext, R.drawable.icon_live_gift_hot);
        mDrawableGuard = ContextCompat.getDrawable(mContext, R.drawable.icon_live_gift_guard);
        mDrawableLuck = ContextCompat.getDrawable(mContext, R.drawable.icon_live_gift_luck);
        mDrawableGlobal = ContextCompat.getDrawable(mContext, R.drawable.icon_live_gift_global);
        mDrawableTu = ContextCompat.getDrawable(mContext, R.drawable.icon_live_gift_tu);
        mDrawableHao = ContextCompat.getDrawable(mContext, R.drawable.icon_live_gift_hao);
    }
    ...
    class Vh extends RecyclerView.ViewHolder {
        ...
        void setData(LiveGiftBean bean, int position, Object payload) {
            if (payload == null) {
                ...
                bean.setView(mIcon);
                mName.setText(bean.getNameTrans());
