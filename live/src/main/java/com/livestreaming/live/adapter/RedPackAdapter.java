...
import com.livestreaming.live.custom.MyImageView;
...
public class RedPackAdapter extends RecyclerView.Adapter<RedPackAdapter.Vh> {
    ...
    public RedPackAdapter(final Context context, List<RedPackBean> list) {
        ...
        mTypeString1 = WordUtil.getString(com.livestreaming.common.R.string.red_pack_11);
        mTypeString2 = WordUtil.getString(com.livestreaming.common.R.string.red_pack_12);
    ...
    class Vh extends RecyclerView.ViewHolder {
        ...
        void setData(RedPackBean bean, int position, Object payload) {
            ...
            if (bean.getRobTime() == 0) {//即使红包或者延时红包时间走完
                ...
                mTime.setText(com.livestreaming.common.R.string.red_pack_10);
                ...
                mTime.setText(StringUtil.getDurationText2(bean.getRobTime(),mStringBuilder));
                mImg.stopAnim();
            }
        }
