...
public class LiveConfigBean implements Parcelable{
    ...
    public LiveConfigBean(Parcel in) {
    ...
    public static final Creator<LiveConfigBean> CREATOR = new Creator<LiveConfigBean>() {
        @Override
        public LiveConfigBean createFromParcel(Parcel in) {
            return new LiveConfigBean(in);
        }

        @Override
        public LiveConfigBean[] newArray(int size) {
            return new LiveConfigBean[size];
        }
    };
}
