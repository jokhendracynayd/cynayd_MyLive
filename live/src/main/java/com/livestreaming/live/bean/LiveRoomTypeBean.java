...
public class LiveRoomTypeBean {
    ...
    public static List<LiveRoomTypeBean> getLiveTypeList(String[][] liveTypes, Context context) {
            ...
            for (String[] arr : liveTypes) {
                ...
                switch (bean.getId()) {
                    case Constants.LIVE_TYPE_NORMAL:
                        bean.setName(context.getString(com.livestreaming.common.R.string.main_live_type_normal));
                        bean.setCheckedIcon(R.mipmap.icon_live_type_normal_1);
                        bean.setUnCheckedIcon(R.mipmap.icon_live_type_normal_2);
                        break;
                    case Constants.LIVE_TYPE_PWD:
                        bean.setName(context.getString(com.livestreaming.common.R.string.main_live_type_pwd));
                        bean.setCheckedIcon(R.mipmap.icon_live_type_pwd_1);
                        bean.setUnCheckedIcon(R.mipmap.icon_live_type_pwd_2);
                        break;
                    case Constants.LIVE_TYPE_PAY:

                        bean.setName(context.getString(com.livestreaming.common.R.string.main_live_type_pay));
                        bean.setCheckedIcon(R.mipmap.icon_live_type_pay_1);
                        bean.setUnCheckedIcon(R.mipmap.icon_live_type_pay_2);
                        break;
                    case Constants.LIVE_TYPE_TIME:
                        bean.setName(context.getString(com.livestreaming.common.R.string.main_live_type_time));
