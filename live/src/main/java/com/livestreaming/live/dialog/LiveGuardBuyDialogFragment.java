...
import com.livestreaming.live.adapter.GuardRightAdapter;
import com.livestreaming.live.bean.GuardBuyBean;
import com.livestreaming.live.bean.GuardRightBean;
...
public class LiveGuardBuyDialogFragment extends AbsDialogFragment implements View.OnClickListener {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            mCoinName = coinName;
            mCoinNameTextView.setText(WordUtil.getString(com.livestreaming.common.R.string.guard_my) + coinName + ":");
        }
...
//        }
    ...
    private void clickBuyGuard() {
        ...
        if (mLiveGuardInfo.getMyGuardType() > mTargetBuyBean.getType()) {
            DialogUitl.showSimpleTipDialog(mContext, WordUtil.getString(com.livestreaming.common.R.string.guard_buy_tip));
            return;
        } else {
            if (mLiveGuardInfo.getMyGuardType() == Constants.GUARD_TYPE_MONTH
                    && mTargetBuyBean.getType() == Constants.GUARD_TYPE_YEAR) {
                DialogUitl.showSimpleDialog(mContext, WordUtil.getString(com.livestreaming.common.R.string.guard_buy_tip_2), new DialogUitl.SimpleCallback() {
                    @Override
    ...
    private void buyGuard() {
        ...
        DialogUitl.showSimpleDialog(mContext,
                String.format(WordUtil.getString(com.livestreaming.common.R.string.guard_buy_tip_3), mTargetBuyBean.getCoin(), mCoinName, mTargetBuyBean.getShopName()),
