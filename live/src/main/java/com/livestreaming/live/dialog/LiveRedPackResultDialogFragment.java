...
import com.livestreaming.live.adapter.RedPackResultAdapter;
import com.livestreaming.live.bean.RedPackBean;
import com.livestreaming.live.bean.RedPackResultBean;
            ...
            public void onSuccess(int code, String msg, String[] info) {
                if (code == 0 && info.length > 0) {
                    ...
                    if (redPackInfo != null) {
                        ...
                        if (mName != null) {
                            mName.setText(String.format(WordUtil.getString(com.livestreaming.common.R.string.red_pack_17), redPackInfo.getString("user_nickname")));
                        }
                        if (mNum != null) {
                            mNum.setText(String.format(WordUtil.getString(com.livestreaming.common.R.string.red_pack_19),
                    ...
                    if (TextUtils.isEmpty(winCoinVal) || "0".equals(winCoinVal)) {//没抢到
                        ...
                        if (mCoinNameTextView != null) {
                            mCoinNameTextView.setText(String.format(WordUtil.getString(com.livestreaming.common.R.string.red_pack_18), mCoinName));
                        }
                    }
