...
import com.livestreaming.live.adapter.RedPackAdapter;
...
import com.livestreaming.live.interfaces.RedPackCountDownListener;
...
//        mText = mRootView.findViewById(R.id.text);
        ...
        if (mRedPackBean.getSendType() == Constants.RED_PACK_SEND_TIME_DELAY && mRedPackBean.getRobTime() != 0) {
            ...
            if (mCountDown != null) {
                ...
                mCountDown.setText(StringUtil.getDurationText2(mRedPackBean.getRobTime(),mStringBuilder));
            }
...
//        }
        ...
        if (mWinTip != null) {
            mWinTip.setText(String.format(WordUtil.getString(com.livestreaming.common.R.string.red_pack_16), mRedPackBean.getUserNiceName(), mCoinName));
        }
    }
    ...
    public void onCountDown(int lastTime) {
        if (lastTime == 0) {
            ...
            if (mCountDown != null) {
                ...
                mCountDown.setText(StringUtil.getDurationText2(lastTime,mStringBuilder));
            }
        }
    }
