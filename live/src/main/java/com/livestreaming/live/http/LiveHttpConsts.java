...
public class LiveHttpConsts {
    ...
    public static final String GET_LIVE_USER_RANK = "getLiveUserRank";
    ...
    public static final String GET_SUPER_FORBID_TIME = "getSuperForbidTime";
    ...
    public static final String GET_SW_RTC_TOKEN = "getSwRtcToken";
    public static final String GET_SW_RTC_PKTOKEN = "getSwRtcPKToken";
    ...
    public static final String GET_LIVE_BAN_INFO = "getLiveBanInfo";
    ...
    public static final String CHECK_SOCKET_CONNECT = "checkSocketConnect";
    ...
    public static final String CLEAR_TURN_RECORD = "clearTurnRecord";
    ...
    public static final String SET_PLAT_GOODS_SALE = "setPlatGoodsSale";
    public static final String SEARCH_LIVE_GOODS_LIST = "Shop.GetGoodsList";
    public static final String SEARCH_LIVE_PLAT_GOODS_LIST = "searchLivePlatGoodsList";
    public static final String SET_LIVE_GOODS_SHOW = "setLiveGoodsShow";
    public static final String GET_DAILY_TASK = "getDailyTask";
    public static final String DAILY_TASK_SHARE_LIVE = "dailyTaskShareLive";
    public static final String DAILY_TASK_REWARD = "dailyTaskReward";
    public static final String APPLY_VOICE_LIVE_MIC = "applyVoiceLiveMic";
    public static final String CANCEL_VOICE_LIVE_MIC = "cancelVoiceLiveMic";
    public static final String GET_VOICE_MIC_APPLY_LIST = "getVoiceMicApplyList";
    public static final String USER_DOWN_VOICE_MIC = "userDownVoiceMic";
    public static final String HANDLE_VOICE_MIC_APPLY = "handleVoiceMicApply";
    public static final String GET_VOICE_CONTROL_LIST = "getVoiceControlList";
    public static final String BAN_EMPTY_MIC_POSITION = "banEmptyMicPosition";
    public static final String CLOSE_USER_VOICE_MIC = "closeUserVoiceMic";
    public static final String CHANGE_VOICE_MIC_OPEN = "changeVoiceMicOpen";
    public static final String GET_VOICE_MIC_STREAM = "getVoiceMicStream";
    public static final String GET_VOICE_LIVE_PULL_STREAMS = "getVoiceLivePullStreams";
    public static final String GET_NEW_UP_MIC_PULL_URL = "getNewUpMicPullUrl";
    public static final String SET_USER_HOME_BG_IMG = "setUserHomeBgImg";
