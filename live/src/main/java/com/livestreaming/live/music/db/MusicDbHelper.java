package com.livestreaming.live.music.db;
...
public class MusicDbHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "livestreaming.music";
    ...
    public MusicDbHelper() {
        super(CommonAppContext.getInstance(), DATABASE_NAME, null, DATABASE_VERSION);
    }
