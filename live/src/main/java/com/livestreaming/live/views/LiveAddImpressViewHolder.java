...
public class LiveAddImpressViewHolder extends AbsLivePageViewHolder {
            ...
            public void onClick(View v) {
                ...
                if (!mtv.isChecked()) {
                    if (mLinkedList.size() < 3) {
                        ...
                        ToastUtil.show(com.livestreaming.common.R.string.impress_add_max);
                    }
                } else {
    ...
    private void save() {
        if (mLinkedList.size() == 0) {
            ToastUtil.show(com.livestreaming.common.R.string.impress_please_choose);
            return;
        }
        if (!mChanged) {
            ToastUtil.show(com.livestreaming.common.R.string.impress_not_changed);
            return;
        }
        String ids = "";
