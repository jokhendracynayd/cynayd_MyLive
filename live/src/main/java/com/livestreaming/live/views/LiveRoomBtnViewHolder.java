...
public class LiveRoomBtnViewHolder extends AbsViewHolder implements View.OnClickListener {
    ...
    private int mDailyTaskSwitch;//每日任务开关 0 关 1 开
...
//    private View mPrizePoolGuang;
    ...
    public LiveRoomBtnViewHolder(Context context, ViewGroup parentView, boolean showPan, int prizePoolLevel,int dailyTaskSwitch) {
        super(context, parentView, showPan, prizePoolLevel,dailyTaskSwitch);
    }
    ...
    public void init() {
        ...
        if(mDailyTaskSwitch==1&& CommonAppConfig.getInstance().isLogin()){
