...
import com.livestreaming.main.adapter.ActiveCommentAdapter;
...
public class ActiveDetailActivity extends AbsActivity implements ActiveCommentAdapter.ActionListener, OnItemClickListener<ActiveCommentBean>, KeyBoardUtil.KeyBoardHeightListener {
    ...
    @Override
    protected void main() {
        setTitle(WordUtil.getString(com.livestreaming.common.R.string.active_detail));
        ...
        mInputViewHolder = new InputViewHolder(mContext,
                ...
                false, R.layout.view_input_top_active, com.livestreaming.common.R.layout.view_input_face
        );
        ...
        if (!CommonAppConfig.getInstance().isLogin()) {
            View inputCover = findViewById(R.id.input_cover);
            inputCover.setVisibility(View.VISIBLE);
            inputCover.setOnClickListener(new View.OnClickListener() {
                @Override
