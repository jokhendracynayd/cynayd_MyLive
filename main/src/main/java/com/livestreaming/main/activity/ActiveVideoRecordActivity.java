...
public class ActiveVideoRecordActivity extends AbsActivity implements View.OnClickListener, TXRecordCommon.ITXVideoRecordListener {
    ...
    protected void main() {
        ...
        mFlashDrawable0 = ContextCompat.getDrawable(mContext, com.livestreaming.video.R.mipmap.icon_video_flash_0);
        mFlashDrawable1 = ContextCompat.getDrawable(mContext,com.livestreaming.video. R.mipmap.icon_video_flash_1);
        mPlayDrawable0 = ContextCompat.getDrawable(mContext, com.livestreaming.common.R.mipmap.icon_play_0);
        mPlayDrawable1 = ContextCompat.getDrawable(mContext, com.livestreaming.common.R.mipmap.icon_play_1);
...
//        findViewById(R.id.btn_re_record).setOnClickListener(this);
        ...
        //按钮动画相关
        mVideoRecordBtnView = (VideoRecordBtnView) findViewById(com.livestreaming.video.R.id.record_btn_view);
        mRecordView = findViewById(com.livestreaming.video.R.id.record_view);
        mUnRecordDrawable = ContextCompat.getDrawable(mContext, com.livestreaming.video.R.drawable.bg_btn_record_1);
        mRecordDrawable = ContextCompat.getDrawable(mContext, com.livestreaming.video.R.drawable.bg_btn_record_2);
    ...
    private void clickPlay() {
        ...
        if (mPlayStarted) {
            ...
            mPlayer.startVodPlay(mVideoPath);
            mPlayStarted = true;
            mPlaying = true;
            if (mBtnPlay != null) {
...
//        }
    ...
    private void useVideo() {
        ...
        MediaUtil.saveVideoInfo(mContext, mVideoPath, mVideoDuration);
