...
//                } else
    ...
    @Override
    protected void main() {
        setTitle(WordUtil.getString(com.livestreaming.common.R.string.a_064));
...
//        else
    ...
    public void submit() {
        ...
        if (TextUtils.isEmpty(familyName)) {
            ToastUtil.show(com.livestreaming.common.R.string.a_025);
            return;
        }
        final String userName = mUserName.getText().toString();
        if (TextUtils.isEmpty(userName)) {
            ToastUtil.show(com.livestreaming.common.R.string.a_027);
            return;
        }
        ...
        if (TextUtils.isEmpty(chou)) {
            ToastUtil.show(com.livestreaming.common.R.string.a_035);
            return;
        }
        final String familyDes = mFamilyDes.getText().toString();
        if (TextUtils.isEmpty(familyDes)) {
            ToastUtil.show(com.livestreaming.common.R.string.a_036);
            return;
        }
...
//                            } else
        ...
        MainHttpUtil.createFamily(familyName, userName, cardNo, chou, familyDes, "", "", mImgFamilyUrl, new HttpCallback() {
            @Override
