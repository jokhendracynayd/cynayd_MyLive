...
import com.livestreaming.main.adapter.MallClassAdapter;
...
public class MallClassActivity extends AbsActivity implements View.OnClickListener {
    ...
    protected void main() {
        ...
        mColor0 = ContextCompat.getColor(mContext, com.livestreaming.common.R.color.gray1);
        mColor1 = ContextCompat.getColor(mContext, com.livestreaming.common.R.color.textColor);
...
//                simplePagerTitleView.setPadding(0, 0, 0, 0);
                simplePagerTitleView.setNormalColor(ContextCompat.getColor(mContext, com.livestreaming.common.R.color.textColor));
                simplePagerTitleView.setSelectedColor(ContextCompat.getColor(mContext, com.livestreaming.common.R.color.global));
