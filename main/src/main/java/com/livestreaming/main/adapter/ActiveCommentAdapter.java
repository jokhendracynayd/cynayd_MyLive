...
import com.livestreaming.main.bean.ActiveCommentBean;
...
public class ActiveCommentAdapter extends RefreshAdapter<ActiveCommentBean> {
        ...
        mOnLongClickListener = new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                if (tag != null && mActionListener != null) {
                    mActionListener.onItemLongClick((ActiveCommentBean) tag);
                }
                return true;
            }
        };
    ...
    class Vh extends RecyclerView.ViewHolder {
        ...
        public Vh(View itemView) {
            super(itemView);
            mName = (TextView) itemView.findViewById(com.livestreaming.video.R.id.name);
            mContent = (TextView) itemView.findViewById(com.livestreaming.video.R.id.content);
...
//                    mName.setTag(R.id.avatar, u.getId());
    ...
    class ParentVh extends Vh {
        ...
        public ParentVh(View itemView) {
            super(itemView);
            mBtnLike = (ImageView) itemView.findViewById(com.livestreaming.video.R.id.btn_like);
            mLikeNum = (TextView) itemView.findViewById(com.livestreaming.video.R.id.like_num);
            mBtnLike.setOnClickListener(mLikeClickListener);
            mAvatar = itemView.findViewById(com.livestreaming.video.R.id.avatar);
        }
    ...
    class ChildVh extends Vh {
        ...
        public ChildVh(View itemView) {
            super(itemView);
            mBtnGroup = itemView.findViewById(com.livestreaming.video.R.id.btn_group);
            mBtnExpand = itemView.findViewById(com.livestreaming.video.R.id.btn_expand);
            mBtnbCollapsed = itemView.findViewById(com.livestreaming.video.R.id.btn_collapsed);
    ...
    public interface ActionListener {
        ...
        void onItemLongClick(ActiveCommentBean bean);
    }
