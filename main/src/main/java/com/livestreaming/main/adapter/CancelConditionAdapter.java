...
public class CancelConditionAdapter extends RefreshAdapter<CancelConditionBean> {
    ...
    public CancelConditionAdapter(Context context, List<CancelConditionBean> list) {
        ...
        mColor0 = ContextCompat.getColor(context, com.livestreaming.common.R.color.global);
        mColor1 = ContextCompat.getColor(context, com.livestreaming.common.R.color.gray1);
        mString0 = WordUtil.getString(com.livestreaming.common.R.string.cancel_account_6);
        mString1 = WordUtil.getString(com.livestreaming.common.R.string.cancel_account_5);
    }
