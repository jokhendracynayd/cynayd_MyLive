...
public class CoinAdapter extends RecyclerView.Adapter {
    ...
    public CoinAdapter(Context context, String coinName) {
        ...
        mGiveString = WordUtil.getString(com.livestreaming.common.R.string.coin_give);
        ...
        mCheckedDrawable = ContextCompat.getDrawable(context, com.livestreaming.common.R.mipmap.bg_coin_item_1);
        mUnCheckedDrawable = ContextCompat.getDrawable(context, com.livestreaming.common.R.mipmap.bg_coin_item_0);
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new Vh(mInflater.inflate(com.livestreaming.common.R.layout.item_coin, parent, false));
    }
    ...
    class Vh extends RecyclerView.ViewHolder {
        ...
        public Vh(View itemView) {
            ...
            mGive = itemView.findViewById(com.livestreaming.common.R.id.give);
