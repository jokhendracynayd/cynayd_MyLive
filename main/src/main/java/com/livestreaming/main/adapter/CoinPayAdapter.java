...
public class CoinPayAdapter extends RecyclerView.Adapter<CoinPayAdapter.Vh> {
    ...
    public CoinPayAdapter(Context context) {
        ...
        mCheckedDrawable = ContextCompat.getDrawable(mContext, com.livestreaming.common.R.mipmap.ic_check_2_1);
        mUnCheckedDrawable = ContextCompat.getDrawable(mContext, com.livestreaming.common.R.mipmap.ic_check_2_0);
    }
    ...
    public Vh onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new Vh(mInflater.inflate(com.livestreaming.common.R.layout.item_coin_pay, parent, false));
    }
    ...
    class Vh extends RecyclerView.ViewHolder {
        ...
        public Vh(View itemView) {
            ...
            mCheck = itemView.findViewById(com.livestreaming.common.R.id.check);
