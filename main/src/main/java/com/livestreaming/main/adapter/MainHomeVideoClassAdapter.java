...
public class MainHomeVideoClassAdapter extends RefreshAdapter<VideoClassBean> {
    ...
    public MainHomeVideoClassAdapter(Context context, List<VideoClassBean> list) {
        super(context, list);
        mCheckedColor = ContextCompat.getColor(mContext, com.livestreaming.common.R.color.global);
        mUnCheckedColor = ContextCompat.getColor(mContext, com.livestreaming.common.R.color.gray1);
