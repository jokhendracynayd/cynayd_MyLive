...
public class MainLiveClassAdapter extends RefreshAdapter<LiveClassBean> {
    ...
    public MainLiveClassAdapter(Context context) {
        super(context);
        mList.add(new LiveClassBean(0, WordUtil.getString(com.livestreaming.common.R.string.live), true));
        mList.add(new LiveClassBean(1, WordUtil.getString(com.livestreaming.common.R.string.a_039), false));
        mCheckedColor = ContextCompat.getColor(mContext, com.livestreaming.common.R.color.white);
        mUnCheckedColor = Color.parseColor("#7D7D7D");
