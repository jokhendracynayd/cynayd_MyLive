...
public class ShopAdapter extends RefreshAdapter<GoodsBean> {
    ...
    class Vh extends RecyclerView.ViewHolder {
        ...
        void setData(GoodsBean bean) {
            ...
            if(status==-2){
                mTvStatus.setText(WordUtil.getString(com.livestreaming.common.R.string.goods_tip_37));
                mTvStatus.setVisibility(View.VISIBLE);
            }else if(status==-1){
                mTvStatus.setText(WordUtil.getString(com.livestreaming.common.R.string.goods_tip_38));
                mTvStatus.setVisibility(View.VISIBLE);
            }else{
