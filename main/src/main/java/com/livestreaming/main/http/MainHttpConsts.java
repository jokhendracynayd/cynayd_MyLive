...
public class MainHttpConsts {
    ...
    public static final String GET_VOICE_ROOM_LIST = "getVoiceRoomList";
    public static final String GET_RECOMMEND_LIVE = "getRecommendLive";
    ...
    public static final String GET_ACTIVE_HOT_TOPIC = "getActiveHotTopic";
    public static final String GET_ACTIVE_ALL_TOPIC = "getActiveAllTopic";
    public static final String GET_TOPIC_ACTIVE_LIST = "getTopicActiveList";
    public static final String SEARCH_ACTIVE_TOPIC = "searchActiveTopic";
    public static final String GET_ACTIVE_RECOM_TOPIC = "getActiveRecomTopic";
    public static final String SET_AUTH = "setAuth";
    public static final String CHECK_TEENAGER = "checkTeenager";
    public static final String OPEN_TEENAGER = "openTeenager";
    public static final String CLOSE_TEENAGER = "closeTeenager";
    public static final String MODIFY_TEENAGER_PWD = "modifyTeenagerPwd";
    public static final String CHANGE_TEENAGER_TIME = "changeTeenagerTime";
    public static final String SET_LIVE_WINDOW = "setLiveWindow";
