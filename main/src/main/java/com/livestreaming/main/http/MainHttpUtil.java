package com.livestreaming.main.http;
...
import com.livestreaming.main.utils.CryptoUtil;
...
public class MainHttpUtil {
     ...
     * 第三方登录
     */
    public static void loginByThird(String openid, String access_token, String nicename, String avatar, String type, HttpCallback callback) {
    ...
    public static void checkAgent(HttpCallback callback) {
        HttpClient.getInstance().get("Agent.checkAgent", MainHttpConsts.CHECK_AGENT)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("device_id", CryptoUtil.encrypt(CommonAppConfig.getInstance().getNewDeviceId()))
                .execute(callback);
    }
     ...
     * 获取用户信息
     */
    public static void getBaseInfo(String uid, String token, final CommonCallback<UserBean> commonCallback, final Runnable loginInvalidRunnable) {
                ...
                .execute(new HttpCallback() {
                    ...
                    public void onSuccess(int code, String msg, String[] info) {
                        if (code == 0 && info.length > 0) {
                            ...
                            bean.setIsDataEditedFirst(obj.getInteger("is_data_edited_first"));
                            CommonAppConfig.getInstance().setUserBean(bean);
                            CommonAppConfig.getInstance().setShowLiveFloatWindow(obj.getIntValue("live_window") == 1);
                    ...
                    public boolean isUseLoginInvalid() {
                        return loginInvalidRunnable != null;
                    }

                    @Override
                    public void onLoginInvalid() {
                        if (loginInvalidRunnable != null) {
                            loginInvalidRunnable.run();
                        }
                    }
                });
    }
    ...
    public static void loginWithGoogle(String user_login, String pass, String pass2,String google_id, HttpCallback callback) {
        HttpClient.getInstance().get("Login.googleLogin", "")
                .params("user_login", user_login)
                .params("user_pass", pass)
                .params("user_pass2", pass2)
...
//                .params("old_price", goodsBean.getPriceOrigin())
    ...
    public static void activePublish(
            ...
            String videoUrl, String address, String voiceUrl, int voiceDuration, String topicId, String goodsId,
     ...
     * 获取用户是否开启青少年模式
     */
    public static void checkTeenager(HttpCallback callback) {
        HttpClient.getInstance().get("User.checkTeenager", MainHttpConsts.CHECK_TEENAGER)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
     ...
     * 开启青少年模式
     */
    public static void openTeenager(String password, int type, HttpCallback callback) {
     ...
     * 关闭青少年模式
     */
    public static void closeTeenager(String password, HttpCallback callback) {
     ...
     * 修改青少年模式密码
     */
    public static void modifyTeenagerPwd(String oldpassword, String password, HttpCallback callback) {
        HttpClient.getInstance().get("User.updateTeenagerPassword", MainHttpConsts.MODIFY_TEENAGER_PWD)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
     ...
     * 消耗青少年模式下App的使用时间
     */
    public static void changeTeenagerTime(HttpCallback callback) {
        HttpClient.getInstance().get("User.addTeenagerTime", MainHttpConsts.CHANGE_TEENAGER_TIME)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
     ...
     * 用户设置直播小窗
     */
    public static void setLiveWindow(HttpCallback callback) {
        HttpClient.getInstance().get("User.setLiveWindow", MainHttpConsts.SET_LIVE_WINDOW)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
    ...
    public static void sendAndSaveFirebaseToken(String s, HttpCallback httpCallback) {
        HttpClient.getInstance().get("User.setUserToken", MainHttpConsts.SET_LIVE_WINDOW)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", s)
                .execute(httpCallback);
    }

    public static void getHot2(int i, HttpCallback httpCallback) {
        HttpClient.getInstance().get("Home.getHot2","")
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("p", i)
                .execute(httpCallback);
    ...
    public static void updateUserCountry(String code, HttpCallback callback) {
        HttpClient.getInstance().get("User.update_country", MainHttpConsts.GET_FOLLOW)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("code", code)
                .execute(callback);
