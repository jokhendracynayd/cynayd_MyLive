...
import com.livestreaming.live.activity.LiveGuardListActivity;
...
import com.livestreaming.main.activity.MyImpressActivity;
import com.livestreaming.main.activity.UserHomeActivity;
import com.livestreaming.main.bean.UserHomeConBean;
        ...
        if (mImpressGroup != null) {
            ...
            if (list.size() == 0) {
                if (mSelf) {
                    ...
                    TextView textView = (TextView) mInflater.inflate(com.livestreaming.live.R.layout.view_impress_item_add, mImpressGroup, false);
            ...
            for (int i = 0, size = list.size(); i < size; i++) {
                MyTextView myTextView = (MyTextView) mInflater.inflate(com.livestreaming.live.R.layout.view_impress_item_3, mImpressGroup, false);
    ...
    public void showData(SearchUserBean userBean, JSONObject obj) {
        ...
        if (mVotesName != null) {
            if(LanguageUtil.isZh()){
                mVotesName.setText(StringUtil.contact(CommonAppConfig.getInstance().getVotesName(), WordUtil.getString(com.livestreaming.common.R.string.live_user_home_con)));
            }else{
                mVotesName.setText( WordUtil.getString(com.livestreaming.common.R.string.live_user_home_con));
            }
        }
        if (mBirthday != null) {
            mBirthday.setText(StringUtil.contact(WordUtil.getString(com.livestreaming.common.R.string.edit_profile_birthday), "： ", obj.getString("birthday")));
        }
        if (mCity != null) {
            mCity.setText(StringUtil.contact(WordUtil.getString(com.livestreaming.common.R.string.edit_profile_city), "： ", obj.getString("location")));
        }
