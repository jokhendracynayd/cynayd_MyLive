...
public class BuyerAddressEditActivity extends AbsActivity implements View.OnClickListener {
    ...
    SwitchCompat default_shipping_address_switch;
    private String countryName="",countryCode="";

    @Override
    protected int getLayoutId() {
        return R.layout.address_edit_add_layout;
    }
    ...
    protected void main() {
        ...
        city_value=findViewById(R.id.city_value);
         default_shipping_address_switch=findViewById(R.id.default_shipping_address_switch);
    }
