...
import com.livestreaming.mall.adapter.GoodsClassLeftAdapter;
import com.livestreaming.mall.adapter.GoodsClassRightAdapter;
import com.livestreaming.mall.bean.GoodsClassBean;
import com.livestreaming.mall.bean.GoodsClassTitleBean;
...
public class ChooseGoodsClassActivity extends AbsActivity implements OnItemClickListener<GoodsClassBean> {
    ...
    @Override
    protected void main() {
        setTitle(WordUtil.getString(com.livestreaming.common.R.string.mall_077));
