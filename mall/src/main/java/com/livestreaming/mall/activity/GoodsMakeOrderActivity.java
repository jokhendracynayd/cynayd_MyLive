...
import com.livestreaming.common.utils.CalculateUtil;
...
public class GoodsMakeOrderActivity extends AbsActivity implements View.OnClickListener, GoodsPayDialogFragment.ActionListener {
    ...
    public static void forward(Context context, String shopName, String goodsId, String goodsName, GoodsSpecBean goodsSpecBean, int count, double postage, String liveUid, String shareUid) {
    ...
    @Override
    protected void main() {
        setTitle(WordUtil.getString(com.livestreaming.common.R.string.mall_187));
        ...
        mTipAddress = findViewById(R.id.address_tip);
...
//        mPostageFree = findViewById(R.id.postage_free);
        ...
        mGoodsSpec.setText(String.format(WordUtil.getString(com.livestreaming.common.R.string.mall_188), specBean.getName()));
...
//        }
    ...
    private void showAddress(BuyerAddressBean bean) {
        if (bean != null) {
            ...
            if (mGroupAddress != null && mGroupAddress.getVisibility() != View.VISIBLE) {
                mGroupAddress.setVisibility(View.VISIBLE);
            }
            if (mTipAddress != null && mTipAddress.getVisibility() == View.VISIBLE) {
                mTipAddress.setVisibility(View.INVISIBLE);
            }
            if (mName != null) {
    ...
    private void submit() {
        ...
        if (mBuyerAddressBean == null) {
            ToastUtil.show(com.livestreaming.common.R.string.mall_189);
            return;
        }
        String msg = mMessage.getText().toString().trim();
        MallHttpUtil.buyerCreateOrder(mBuyerAddressBean.getId(), mGoodsId, mSpecBean.getId(), mCountVal, msg, mLiveUid, mShareUid,
                new HttpCallback() {
                    @Override
                    public void onSuccess(int code, String msg, String[] info) {
                        if (code == 0 && info.length > 0) {
