...
import com.livestreaming.mall.dialog.PayContentResultDialogFragment;
import com.livestreaming.mall.dialog.PayContentTipDialogFragment;
...
public class PayContentActivity1 extends AbsActivity implements View.OnClickListener {
    ...
    @Override
    protected void main() {
        setTitle(WordUtil.getString(com.livestreaming.common.R.string.mall_309));
                ...
                if (code == 0 && info.length > 0) {
                    ...
                    if (obj.getIntValue("isauth") == 0) {
                        new DialogUitl.Builder(mContext)
                                ...
                                .setConfrimString(WordUtil.getString(com.livestreaming.common.R.string.mall_143))
