...
import com.livestreaming.common.custom.StarCountView;
...
import com.livestreaming.mall.adapter.PayContentVideoPlayAdapter;
import com.livestreaming.mall.bean.PayContentVideoPlayBean;
import com.livestreaming.mall.dialog.PayCommentDialogFragment;
import com.livestreaming.mall.dialog.PayContentPayDialogFragment;
...
public class PayContentDetailActivity extends AbsActivity implements OnItemClickListener<PayContentVideoPlayBean>, PayContentPayDialogFragment.ActionListener {
    ...
    @Override
    protected void main() {
        setTitle(WordUtil.getString(com.livestreaming.common.R.string.mall_343));
        ...
        MallHttpUtil.getPayContentDetail(mGoodsId, new HttpCallback() {
            ...
            public void onSuccess(int code, String msg, String[] info) {
                if (code == 0 && info.length > 0) {
                    ...
                    if (mSaleNum != null) {
                        mSaleNum.setText(String.format(WordUtil.getString(com.livestreaming.common.R.string.mall_341), obj.getString("sale_nums")));
                    }
                    if (mDes != null) {
                    ...
                    if (userInfo != null) {
                        ...
                        if (mUserName != null) {
                            mUserName.setText(userInfo.getString("user_nickname"));
                        }
                    }
                    if (mStar != null) {
                    ...
                    if (mCommentNum != null) {
                        mCommentNum.setText(String.format(WordUtil.getString(com.livestreaming.common.R.string.mall_351), obj.getString("evaluate_nums")));
                    }
                    ...
                    if (videoList != null && videoList.size() > 0) {
                        if (videoList.size() > 1) {
                            ...
                            if (mNum != null) {
                                mNum.setText(String.format(WordUtil.getString(com.livestreaming.common.R.string.mall_349), videoList.get(0).getDurationString()));
                            }
    ...
    private void play() {
        if (mVideoList != null && mVideoList.size() > 0) {
            RouteUtil.forwardVideoPlay(mContext, mVideoList.get(0).getUploadResultUrl(), null);
        }
    }
    ...
    public void onItemClick(PayContentVideoPlayBean bean, int position) {
        RouteUtil.forwardVideoPlay(mContext, bean.getUploadResultUrl(), null);
    }
