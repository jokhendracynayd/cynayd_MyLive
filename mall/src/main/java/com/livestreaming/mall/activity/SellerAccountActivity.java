...
public class SellerAccountActivity extends AbsActivity implements View.OnClickListener {
    ...
    public static void forward(Context context) {
        context.startActivity(new Intent(context, SellerAccountActivity.class));
    }
    ...
    @Override
    protected void main() {
        setTitle(WordUtil.getString(com.livestreaming.common.R.string.mall_297));
        ...
        mRefreshView.setEmptyLayoutId(R.layout.view_no_data_refund_record_2);
        ...
        mRefreshView.setDataHelper(new CommonRefreshView.DataHelper<BuyerRefundRecordBean>() {
            ...
            public void loadData(int p, HttpCallback callback) {
                MallHttpUtil.getSellerAccountInfo(p, callback);
            }
            ...
            public List<BuyerRefundRecordBean> processData(String[] info) {
                ...
                mTotalVal = balanceInfo.getString("balance_total");
                mBalanceVal = balanceInfo.getString("balance");
                if (mTotal != null) {
                    mTotal.setText(renderBalanceText(mTotalVal));
                }
                if (mTrade != null) {
                    mTrade.setText(renderBalanceText(balanceInfo.getString("wait_settlement")));
                }
                if (mBalance != null) {
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btn_cash_record) {
            ...
            SellerCashActivity.forward(mContext, mBalanceVal, mTotalVal);
        }
    }
    ...
    protected void onDestroy() {
        MallHttpUtil.cancel(MallHttpConsts.GET_SELLER_ACCOUNT_INFO);
        super.onDestroy();
    }
}
