...
import com.livestreaming.mall.views.SellerDaimaiViewHolder;
import com.livestreaming.mall.views.SellerShenHeViewHolder;
import com.livestreaming.mall.views.SellerXiaJiaViewHolder;
import com.livestreaming.mall.views.SellerZaiShouViewHolder;
...
public class SellerManageGoodsActivity extends AbsActivity implements View.OnClickListener {
    ...
    @Override
    protected void main() {
        setTitle(WordUtil.getString(com.livestreaming.common.R.string.mall_075));
        mZaiShouString = WordUtil.getString(com.livestreaming.common.R.string.mall_109);
        mShenHeString = WordUtil.getString(com.livestreaming.common.R.string.mall_110);
        mXiaJiaString = WordUtil.getString(com.livestreaming.common.R.string.mall_111);
        mDaimaiString = WordUtil.getString(com.livestreaming.common.R.string.mall_409);
