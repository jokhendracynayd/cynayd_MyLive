...
public class SellerRefundDetailActivity extends AbsActivity implements View.OnClickListener {
    ...
    @Override
    protected void main() {
        setTitle(WordUtil.getString(com.livestreaming.common.R.string.mall_202));
        ...
        MallHttpUtil.getSellerRefundDetail(mOrderId, new HttpCallback() {
            ...
            public void onSuccess(int code, String msg, String[] info) {
                if (code == 0 && info.length > 0) {
                    ...
                    if (mRefundType != null) {
                        mRefundType.setText(refundInfo.getIntValue("type") == 0 ? com.livestreaming.common.R.string.mall_255 : com.livestreaming.common.R.string.mall_256);
                    }
                    if (mMoney != null) {
    ...
    private void reject() {
        new DialogUitl.Builder(mContext)
                .setIsHideTitle(true)
                .setConfirmColor(ContextCompat.getColor(mContext, com.livestreaming.common.R.color.gray3))
                .setCancelColor(ContextCompat.getColor(mContext, com.livestreaming.common.R.color.global))
                .setContent(WordUtil.getString(com.livestreaming.common.R.string.mall_280))
                .setCancelable(true)
                .setBackgroundDimEnabled(true)
                .setConfrimString(WordUtil.getString(com.livestreaming.common.R.string.mall_285))
