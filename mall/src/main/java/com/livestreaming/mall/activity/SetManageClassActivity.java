...
import com.livestreaming.mall.adapter.SetManageClassAdapter;
...
public class SetManageClassActivity extends AbsActivity implements SetManageClassAdapter.ActionListener, View.OnClickListener {
    ...
    @Override
    protected void main() {
        setTitle(WordUtil.getString(com.livestreaming.common.R.string.mall_399));
        ...
        String contentFail = WordUtil.getString(com.livestreaming.common.R.string.mall_397);
        String submit = WordUtil.getString(com.livestreaming.common.R.string.mall_398);
