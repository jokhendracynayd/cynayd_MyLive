...
public class GoodsCommentTypeAdapter extends RefreshAdapter<GoodsCommentTypeBean> {
    ...
    public GoodsCommentTypeAdapter(Context context) {
        super(context);
        GoodsCommentTypeBean bean = new GoodsCommentTypeBean("all", WordUtil.getString(com.livestreaming.common.R.string.all));
        bean.setChecked(true);
        mList.add(bean);
        mList.add(new GoodsCommentTypeBean("img", WordUtil.getString(com.livestreaming.common.R.string.mall_290)));
        mList.add(new GoodsCommentTypeBean("video", WordUtil.getString(com.livestreaming.common.R.string.video)));
        mList.add(new GoodsCommentTypeBean("append", WordUtil.getString(com.livestreaming.common.R.string.mall_291)));
        mCheckedColor = ContextCompat.getColor(context,com.livestreaming.common. R.color.white);
        mUnCheckedColor = ContextCompat.getColor(context,com.livestreaming.common. R.color.global);
