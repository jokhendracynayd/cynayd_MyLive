...
public class PayContentVideoPlayAdapter extends RefreshAdapter<PayContentVideoPlayBean> {
    ...
    public PayContentVideoPlayAdapter(Context context) {
        super(context);
        mDurationString = WordUtil.getString(com.livestreaming.common.R.string.mall_349);
    ...
    public void setHasBuy(boolean hasBuy) {
        mHasBuy = hasBuy;
        mTipString = WordUtil.getString(hasBuy ? com.livestreaming.common.R.string.mall_350 : com.livestreaming.common.R.string.mall_332);
    }
