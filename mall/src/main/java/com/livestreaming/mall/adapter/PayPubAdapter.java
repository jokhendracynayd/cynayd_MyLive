...
public class PayPubAdapter extends RefreshAdapter<PayContentBean> {
    ...
    public PayPubAdapter(Context context) {
        super(context);
        mSaleNumString = WordUtil.getString(com.livestreaming.common.R.string.mall_341);
        mShenHeString0 = WordUtil.getString(com.livestreaming.common.R.string.mall_117);
        mShenHeString1 = WordUtil.getString(com.livestreaming.common.R.string.mall_342);
