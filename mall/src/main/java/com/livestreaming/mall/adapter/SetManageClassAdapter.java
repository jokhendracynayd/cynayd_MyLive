...
public class SetManageClassAdapter extends RefreshAdapter<ManageClassBean> {
    ...
    public SetManageClassAdapter(Context context, List<ManageClassBean> list) {
        super(context, list);
        mCheckedColor = ContextCompat.getColor(context, com.livestreaming.common.R.color.textColor);
        mUnCheckedColor = ContextCompat.getColor(context, com.livestreaming.common.R.color.gray3);
