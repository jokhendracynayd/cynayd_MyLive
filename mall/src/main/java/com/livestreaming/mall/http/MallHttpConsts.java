...
public class MallHttpConsts {
    ...
    public static final String GET_GOODS_INFO = CommonHttpConsts.GET_GOODS_INFO;
    ...
    public static final String GET_ADD_PLAT_GOODS = "getAddPlatGoods";
    public static final String SET_PLAT_GOODS = "setPlatGoods";
    public static final String GET_MANAGE_PLAT_GOODS = "getManagePlatGoods";
    ...
    public static final String GET_TO_PAY_CONTENT = "getToPayContent";
    ...
    public static final String SEARCH_PLAT_GOODS_LIST = "searchPlatGoodsList";
    ...
    public static final String GET_BUSINESS_CATEGORY = "getBusinessCategory";
    public static final String CHECK_APPLY_BUSINESS_CATEGORY = "checkApplyBusinessCategory";
    public static final String APPLY_BUSINESS_CATEGORY = "applyBusinessCategory";
