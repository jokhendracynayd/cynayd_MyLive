...
public class VideoGoodsAddAdapter extends RefreshAdapter<GoodsBean> {
    ...
    public VideoGoodsAddAdapter(Context context) {
        ...
        mCheckedDrawable = ContextCompat.getDrawable(mContext, com.livestreaming.common.R.mipmap.icon_check_1);
        mUnCheckedDrawable = ContextCompat.getDrawable(mContext,com.livestreaming.common. R.mipmap.icon_check_0);
    }
